    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(default='', upload_to='offers/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('initiated', 'Initiated'), ('delivered', 'Delivered'), ('paid', 'Paid'), ('updaid', 'Unpaid')], default='unpaid', max_length=50)),
                ('delivery_area', models.CharField(max_length=100)),
                ('order_total', models.CharField(default='', max_length=200)),
                ('payment_method', models.CharField(choices=[('card', 'Card'), ('m-pesa', 'M-Pesa'), ('on-delivery', 'On-Delivery')], default='m-pesa', max_length=100)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
